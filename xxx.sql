...
insert  into `tb_jenis`(`id_jenis`,`kode_jenis`,`kel`,`nm_jenis`,`keterangan`,`gbr_jenis`) values (1,'J001','jantan','Adenium Obesum','di habitatnya yakni sebelah selatan Gurun sahara sosok tanaman ini berbentuk semak yang besar, kaku dan tinggi. Namun setelah \"melanglang buana\" termasuk di Indonesia, sosoknya menjadi berbentuk semak pendek yang kelihatan kompak.',''),(2,'J002','betina','Adenium Arabicum','bla bla bla bala bla bla bla',''),(3,'J003','betina','Adenium Boehmianum','dhuu hcuhgcuh cxjhcuhx chxjchu jxhcuh',''),(4,'J004','jantan','Adenium Coetaneum','chjhcud huhudyu huchduc suduysdy duyduydu',''),(5,'J005','betina','Adenium socrotanum','shdystyd dytydgt yudgfuydguf gdygfysdg',''),(6,'J006','jantan','Adenium Multiflorum','hsydusfu udfhudyfue fdugfiusfs udfiudhfudh dufuh',''),(7,'J007','betina','Adenium Somalense','jdsudfysuf dufydufyudsfy dufyduyus fudshvyus',''),(8,'J008','jantan','Adenium Swazicum','dufhyriugt gudrhuidughuu  huhtgu','');
...
CREATE TABLE `tb_kawin_silang` (
  ...
  `nm_jantan` varchar(50) DEFAULT NULL,
  `kode_betina` varchar(11) NOT NULL,
  `nm_betina` varchar(50) DEFAULT NULL,
  `kode_hasil` varchar(11) NOT NULL,
  `nm_hasil` varchar(50) DEFAULT NULL,
...
insert  into `tb_kawin_silang`(`id_silang`,`kode_jantan`,`nm_jantan`,`kode_betina`,`nm_betina`,`kode_hasil`,`nm_hasil`,`keterangan`) values (2,'J001','Adenium Obesum','J002','Adenium Arabicum','J001','Adenium Obesum','Wah selingkuh tuhhh'),(1,'J001','Adenium Obesum','J002','Adenium Arabicum','J003','Adenium Boehmianum','Hayoooo');
...
insert  into `tb_rek_penyakit`(`id_rek_penyakit`,`kode_gejala`,`kode_penyakit`,`kode_penyebab`,`kode_obat`) values (21,'G017.G022.G023.G001','P002','S001.S002','K005'),(23,'G017.G022.G023.G028.G002.G003.G029','P003','S010.S011','K003.K004'),(24,'G021.G025.G026.G010.G011.G029','P004','S001.S002.S003','K003.K004.K006'),(25,'G019.G020.G023.G024.G001.G002.G029','P005','S009.S010.S011','K001.K002.K003');
